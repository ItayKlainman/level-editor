...
- **Active branch**: `master` — all phases merged; latest tag `v0.5.6` (Layer 1). Layer 2 fixes committed directly on master.
...
```
"com.hoppa.leveleditor.core": "https://github.com/ItayKlainman/level-editor.git?path=Packages/com.hoppa.leveleditor.core#v0.5.6"
```
