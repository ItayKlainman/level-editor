...
{
    // Copy-mirror of the YAK difficulty-curve stack (TierPreset / CurveSegment /
    // curve config), bus-scaled. Bus Buddies 1a has NO click-pattern / complexity
    // axis, so TierPreset omits YAK's Complexity knob. "Conveyor Slots" here means
    // the stationary Active Bus Row slot count.
    [Serializable]
    ...
    [CreateAssetMenu(menuName = "Hoppa/BusBuddies/Generator/Bus Buddies Difficulty Curve")]
    public sealed class BusBuddiesDifficultyCurveConfig : ScriptableObject
    {
